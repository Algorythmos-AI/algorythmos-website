...
export default function HeroIllustration({ title = "AI-Powered Agentic Automation" }) {
  return (
    <div className="relative mx-auto w-full max-w-md h-48 sm:h-64 md:h-80 lg:h-96 rounded-2xl sm:rounded-3xl border border-white/10 bg-gradient-to-br from-gray-900/60 to-black/60 overflow-hidden shadow-2xl hover:scale-[1.02] transition duration-300">
