...
const GlobalMap = () => {
    ...
    return (
        <section className="relative w-full px-4 sm:px-6 lg:px-8 pt-10 pb-8 lg:pt-16 lg:pb-12">
            <div className="mx-auto max-w-6xl space-y-8">
                ...
                <motion.div
                    ...
                    className="relative rounded-3xl bg-gradient-to-br from-violet-600/70 via-indigo-700/70 to-slate-900/90 p-[1px] shadow-[0_24px_80px_rgba(15,23,42,0.85)]"
                >
                    <div className="relative overflow-hidden rounded-[1.4rem] bg-slate-950/80 px-4 py-6 sm:px-8 sm:py-8">
                        {/* Glows */}
                        <div className="pointer-events-none absolute inset-0">
                            <div className="absolute -left-24 top-10 h-56 w-56 rounded-full bg-violet-500/20 blur-3xl" />
                            <div className="absolute right-0 bottom-0 h-64 w-64 rounded-full bg-blue-400/20 blur-3xl" />
                        </div>

                        {/* Abstract map area */}
                        <div className="relative aspect-[16/9] w-full">
                            {/* Background "map" grid */}
                            <div className="absolute inset-6 rounded-[1.25rem] bg-gradient-to-br from-slate-900/80 via-slate-900/40 to-slate-900/90 border border-slate-700/60">
                ...
                <div className="grid gap-4 sm:gap-6 sm:grid-cols-2">
                    <div className="rounded-2xl border border-slate-700/70 bg-slate-950/70 p-4 sm:p-5">
