...
export default function SqlDashboardsPage() {
  ...
  // SEO helpers
  const canonicalUrl = getCanonicalUrl(region, "/services/sql-dashboards");
  const canonicalBase = getCanonicalBase(region);
  const ogLocale = getOgLocale(region);
  const hreflangLinks = generateHreflangLinks("/services/sql-dashboards");
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Service",
            "name": t("serviceSqlDashboards.meta.title"),
            "provider": {
              "@type": "Organization",
              "name": "Algorythmos",
              "url": canonicalBase
            },
            "description": t("serviceSqlDashboards.meta.description"),
            "url": canonicalUrl,
