...
export default function DocumentIntelligencePage() {
  ...
  // SEO helpers
  const canonicalUrl = getCanonicalUrl(region, "/services/document-intelligence");
  const canonicalBase = getCanonicalBase(region);
  const ogLocale = getOgLocale(region);
  const hreflangLinks = generateHreflangLinks("/services/document-intelligence");
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Service",
            "name": t("serviceDocument.meta.title"),
            "provider": {
              "@type": "Organization",
              "name": "Algorythmos",
              "url": canonicalBase
            },
            "description": t("serviceDocument.meta.description"),
            "url": canonicalUrl,
